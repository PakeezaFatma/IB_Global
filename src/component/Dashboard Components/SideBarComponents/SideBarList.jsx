...
const SideBarList = () => {
    ...
    return (
        ...
        <ul className="space-y-2 font-medium">
            <li>
                <button type="button" className={`flex myShadow ${show && "bg-[#5aa0c7]"} items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-[#5aa0c7] dark:text-white dark:hover:bg-gray-700 `} aria-controls="dropdown-example" data-collapse-toggle="dropdown-example" onClick={() => setShow(p => !p)}>
                ...
                {/* {show && <SideBarList />} */}
                {show && <ul id="dropdown-example" className={`py-2 space-y-2`}>
                    <li>
